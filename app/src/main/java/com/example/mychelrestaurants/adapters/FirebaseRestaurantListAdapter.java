package com.example.mychelrestaurants.adapters;
...
import com.example.mychelrestaurants.util.ItemTouchHelperAdapter;
...
public class FirebaseRestaurantListAdapter extends FirebaseRecyclerAdapter<Restaurant, FirebaseRestaurantViewHolder> implements ItemTouchHelperAdapter {
    ...
    @Override
    public void onBindViewHolder(final FirebaseRestaurantViewHolder viewHolder, Restaurant model, int position) {
    ...
    @Override
    protected void onBindViewHolder(@NonNull FirebaseRestaurantViewHolder firebaseRestaurantViewHolder, int i, @NonNull Restaurant restaurant) {
