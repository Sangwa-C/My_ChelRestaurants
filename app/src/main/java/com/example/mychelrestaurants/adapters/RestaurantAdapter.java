...
import com.example.mychelrestaurants.ui.RestaurantsActivity;
...
public class RestaurantAdapter extends RecyclerView.Adapter<RestaurantAdapter.RestaurantViewHolder>{
    ...
    private RestaurantsActivity mContext;
    public RestaurantAdapter(RestaurantsActivity context, List<Business> restaurants) {
        mContext = context;
